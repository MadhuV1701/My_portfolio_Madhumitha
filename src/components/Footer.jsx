    ...
    <footer className="bg-[#111111] text-[#d4d4d4] py-16 px-6 md:px-12 w-full font-mono text-[10px] md:text-xs tracking-widest flex flex-col justify-between min-h-[50vh]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8 w-full items-end font-medium">
        <div className="flex flex-col gap-6">
          <a href="https://github.com/MadhuV1701" target="_blank" rel="noopener noreferrer" className="underline hover:text-white transition-colors underline-offset-4 decoration-1 font-bold">GitHub</a>
          <p className="text-white/60 font-mono text-[9px] md:text-[10px]">
            &copy; 2026 Madhumitha.
          </p>
        </div>

        <div className="flex flex-col gap-1 md:items-center">
          <a href="mailto:madhumitha17012006@gmail.com" className="underline hover:text-white transition-colors underline-offset-4 decoration-1 lowercase">madhumitha17012006@gmail.com</a>
        </div>

        <div className="flex flex-col gap-1 md:items-end">
          <a href="https://www.linkedin.com/in/madhumitha-v-66a129358/" target="_blank" rel="noopener noreferrer" className="underline hover:text-white transition-colors underline-offset-4 decoration-1 font-bold">LinkedIn</a>
        </div>
      </div>
    </footer>
  );
