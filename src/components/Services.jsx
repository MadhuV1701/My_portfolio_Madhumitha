...
const TagCard = ({ number, title, text, listItems, className, aosDelay, aosType, pathLength, containerRef }) => {
      ...
      <div className="max-w-6xl mx-auto relative md:h-[1450px]">
        ...
        <div data-aos="fade-up" className="md:absolute top-10 left-0 md:w-[420px] z-20 mb-16 md:mb-0">
          ...
          <p className="text-gray-500 text-base md:text-lg max-w-sm font-medium leading-relaxed">
            A comprehensive look at my professional experience, education history, achievements, and technical credentials.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-8 md:gap-12 items-center md:block relative z-10 w-full pt-4 md:pt-0 pb-12 md:pb-0">
          ...
          <div 
            data-aos="fade-in" 
            data-aos-delay="600"
            className="hidden md:block absolute top-[1350px] left-[60%] font-['Caveat',cursive] text-3xl text-gray-600 rotate-6"
          >
            Ready to build!
          </div>
